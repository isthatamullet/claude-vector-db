...
from enhanced_context import analyze_feedback_sentiment  # Baseline pattern-based system
from multimodal_analysis_pipeline import MultiModalAnalysisPipeline  # Enhanced semantic system
