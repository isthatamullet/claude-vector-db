...
from enhanced_processor import UnifiedEnhancementProcessor
...
class UnifiedEnhancementEngine:
    ...
    def backfill_engine(self):
        ...
        if self._backfill_engine is None:
            from conversation_backfill_engine import ConversationBackFillEngine
    ...
    def field_optimizer(self):
        ...
        if self._field_optimizer is None:
            from field_population_optimizer import FieldPopulationOptimizer
