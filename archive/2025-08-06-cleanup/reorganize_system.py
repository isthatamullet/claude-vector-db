    ...
    def __init__(self, base_path: str = "/home/user/.claude-vector-db-enhanced"):
        ...
        self.directory_mapping = {
            ...
            "system": [
                ...
                "system/mcp_server.log",
                "system/migration.log",
                "system/sync-output.txt",
                "tylers-notes.txt",
        ...
        self.file_path_mapping = {
            "processing/run_full_sync.py": "processing/run_full_sync.py",
            "/home/user/.claude-vector-db-enhanced/processing/run_full_sync.py": "/home/user/.claude-vector-db-enhanced/processing/run_full_sync.py",
            "mcp/mcp_server.py": "mcp/mcp_server.py", 
            "/home/user/.claude-vector-db-enhanced/mcp/mcp_server.py": "/home/user/.claude-vector-db-enhanced/mcp/mcp_server.py",
            "database/vector_database.py": "database/vector_database.py",
            "/home/user/.claude-vector-db-enhanced/database/vector_database.py": "/home/user/.claude-vector-db-enhanced/database/vector_database.py",
            "system/health_dashboard.sh": "system/health_dashboard.sh",
            "/home/user/.claude-vector-db-enhanced/system/health_dashboard.sh": "/home/user/.claude-vector-db-enhanced/system/health_dashboard.sh",
            "system/mcp_server.log": "system/mcp_server.log",
            "system/migration.log": "system/migration.log",
            "system/sync-output.txt": "system/sync-output.txt"
        }
